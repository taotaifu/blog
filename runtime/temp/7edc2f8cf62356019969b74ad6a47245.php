<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/article/reqycle.html";i:1547795855;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form action="" method="post">
        <table class="layui-table layui-form">
            ...
            <tr cate-id='1' fid='0' >
                ...
                <td class="td-manage">
                    <a class="layui-btn layui-btn layui-btn-xs"  href="<?php echo url('outToReqycle',['arc_id'=>$vo['arc_id']]); ?>" ><i class="layui-icon">&#xe642;</i>回复数据</a>
                    <a class="layui-btn-danger layui-btn layui-btn-xs" href="javascript:;" onclick="del(<?php echo $vo['arc_id']; ?>)"><i class="layui-icon">&#xe640;</i>彻底删除</a>
                </td>
            </tr>
