<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/category/store.html";i:1547612886;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554255206;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="x-body">
    <form class="layui-form" id="form" action="" method="post">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <select type="text"  id="cate_pid" name="cate_pid" required=""
                 autocomplete="off" class="layui-input">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text"  id="cate_sort" name="cate_sort" l
                 autocomplete="off" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
