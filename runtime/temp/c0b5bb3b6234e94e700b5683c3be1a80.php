<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/link/index.html";i:1554276350;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    ...
    <xblock>
        ...
        <a href="<?php echo url('store'); ?>" class="layui-btn layui-btn-danger">添加友链</a>
        ...
        <table class="layui-table layui-form">
           ...
           <?php if(is_array($field) || $field instanceof \think\Collection || $field instanceof \think\Paginator): if( count($field)==0 ) : echo "" ;else: foreach($field as $key=>$vo): ?>
            <tr cate-id='1' fid='0' >
                ...
                <td class="td-manage">
                    <a class="layui-btn layui-btn layui-btn-xs"  href="<?php echo url('store',['link_id'=>$vo['link_id']]); ?>" ><i class="layui-icon">&#xe642;</i>编辑</a>
                    <a class="layui-btn-danger layui-btn layui-btn-xs" href="javascript:;" onclick="del(<?php echo $vo['link_id']; ?>)"><i class="layui-icon">&#xe640;</i>删除</a>
                </td>
            </tr>
