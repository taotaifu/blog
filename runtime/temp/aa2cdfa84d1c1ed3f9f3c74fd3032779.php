<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/article/edit.html";i:1554202260;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    ...
    <xblock>
        ...
        <a href="<?php echo url('edit'); ?>" class="layui-btn layui-btn-danger">编辑文章</a>
    ...
    <form class="layui-form" action="" method="post" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="" name="arc_title" value="<?php echo $oldData['arc_title']; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="" class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="arc_author" value="<?php echo $oldData['arc_author']; ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number"  name="arc_sort" value="<?php echo $oldData['arc_sort']; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="" class="layui-form-label">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input <?php if(in_array($vo['tag_id'],$tag_ids)): ?>checked<?php endif; ?> type="checkbox" name="tag[]" value="<?php echo $vo['tag_id']; ?>" lay-skin="primary" title="<?php echo $vo['tag_name']; ?>" checked="">
                  <div class="layui-unselect layui-form-checkbox layui-form-checked" lay-skin="primary">
                      <span><?php echo $vo['tag_name']; ?></span>
        ...
        <div class="layui-form-item form-group">
            <label for="" class="layui-form-label">
                ...
                <div class="layui-upload" style="margin-left:110px;">
                    <input type="hidden" id="arc_thumb" name="arc_thumb" value="<?php echo $oldData['arc_thumb']; ?>">
    ...
    <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea type="text" placeholder="请输入内容"  value="<?php echo $oldData['arc_digest']; ?>" name="arc_digest" class="layui-textarea"><?php echo $oldData['arc_digest']; ?></textarea>
            </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label for="" class="layui-form-label">
        ...
        <div class="layui-input-block">
             <textarea id="demo" name="arc_content" value="<?php echo $oldData['arc_content']; ?>" style="display: none;"><?php echo $oldData['arc_content']; ?></textarea>
            <script>
