<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/webset/index.html";i:1547804764;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    ...
    <xblock>
        <a href="<?php echo url('index'); ?>" class="layui-btn layui-btn-danger">站点配置</a>
        ...
        <table class="layui-table layui-form">
            ...
            <tr cate-id='1' fid='0' >
                ...
                <td>
                    ...
                    <?php echo $vo['webset_name']; ?>
                </td>

                <td>
                    <input type="text" class="layui-input x-sort" name="order" value="<?php echo $vo['webset_value']; ?>" onblur="change(this,<?php echo $vo['webset_id']; ?>)">
                </td>
