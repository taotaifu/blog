<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/article/index.html";i:1554275657;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form action="" method="post">
        <table class="layui-table layui-form">
            ...
            <tr cate-id='1' fid='0' >
                ...
                <td>
                    <input type="text" class="layui-input x-sort" name="order" value="<?php echo $vo['arc_sort']; ?>" onblur="changeSort(this,<?php echo $vo['arc_id']; ?>)">
                </td>
                <td>
                    <i class="layui-icon x-show" status='true'>&#xe623;</i>
                ...
                <td>
                    <i class="layui-icon x-show" status='true'>&#xe623;</i>
                    <?php echo date('Y-m-d',$vo['sendtime']); ?>
                </td>
                <td class="td-manage">
                    <a class="layui-btn layui-btn layui-btn-xs"  href="<?php echo url('edit',['arc_id'=>$vo['arc_id']]); ?>" ><i class="layui-icon">&#xe642;</i>编辑</a>
                    <a class="layui-btn-danger layui-btn layui-btn-xs" href="<?php echo url('delToRecycle',['arc_id'=>$vo['arc_id']]); ?>"><i class="layui-icon">&#xe640;</i>删除到回收站</a>
                </td>
            </tr>
