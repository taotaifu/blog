<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/tag/store.html";i:1547654759;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554200276;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <xblock>
    ...
    <a href="" class="layui-btn layui-btn-danger">编辑标签</a>
    <?php else: ?>
    <a href="" class="layui-btn layui-btn-danger">添加标签</a>
    <?php endif; ?>
    ...
    <form class="layui-form" id="form" action="" method="post">
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" id="tag_name" value="<?php echo $oldData['tag_name']; ?>" name="tag_name"
