<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/blog_taotaifu_cn/public/../application/admin/view/category/index.html";i:1554276339;s:62:"/www/wwwroot/blog_taotaifu_cn/application/admin/view/base.html";i:1554275153;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <xblock>
    <a href="<?php echo url('index'); ?>" class="layui-btn layui-btn-danger">栏目列表</a>
    <a href="<?php echo url('store'); ?>" class="layui-btn layui-btn-danger">添加栏目</a>
  </xblock>
  ...
  <table class="layui-table layui-form">
    ...
    <tr cate-id='1' fid='0' >
      ...
      <td class="td-manage">
        <a class="layui-btn layui-btn layui-btn-xs"  href="<?php echo url('edit',['cate_id'=>$vo['cate_id']]); ?>" ><i class="layui-icon">&#xe642;</i>编辑</a>
        <a class="layui-btn layui-btn-warm layui-btn-xs"  href="<?php echo url('addSon', ['cate_id'=>$vo['cate_id']]); ?>" ><i class="layui-icon">&#xe642;</i>添加子栏目</a>
        <a class="layui-btn-danger layui-btn layui-btn-xs" href="javascript:;" onclick="del(<?php echo $vo['cate_id']; ?>)"><i class="layui-icon">&#xe640;</i>删除</a>
      </td>
    </tr>
  ...
  <div class="page" style="margin-left: 150px">
    <div>
